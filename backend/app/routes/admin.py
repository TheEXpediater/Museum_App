...
def dashboard(request: Request) -> DashboardSummaryResponse:
    ...
    return DashboardSummaryResponse(
        ...
        published_artifacts=artifact_repository.count_published_artifacts(database),
        draft_artifacts=artifact_repository.count_draft_artifacts(database),
        ai_library_ready_artifacts=artifact_repository.count_ai_library_ready(database),
        ai_library_pending_artifacts=artifact_repository.count_ai_library_pending(database),
        ai_library_stale_artifacts=artifact_repository.count_ai_library_stale(database),
        indexed_artifacts=artifact_repository.count_ai_status(database, ["indexed"]),
        pending_artifacts=artifact_repository.count_ai_library_pending(database),
