...
import androidx.compose.material.icons.filled.QrCodeScanner as FilledQrCodeScanner
...
import androidx.compose.material.icons.outlined.QrCodeScanner as OutlinedQrCodeScanner
...
val VisitorTopLevelDestinations = listOf(
    ...
    VisitorDestination(VisitorRoutes.Scan, "Scan", Icons.Filled.FilledQrCodeScanner, Icons.Outlined.OutlinedQrCodeScanner, opensScanSheet = true),
